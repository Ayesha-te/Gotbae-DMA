...
const Projects = ({ onBack }) => {
  ...
  const projects = [
    {
      ...
      title: "Bc-ppc.com",
      image: c,
      alt: "Bc-ppc.com – PPC automation platform",
      description:
    ...
    },
    {
      ...
      image: b,
      alt: "Dapeshawarde.com – personal branding website",
      description:
    ...
    },
    {
      ...
      image: a,
      alt: "Najebsupermarket.com – e-commerce supermarket platform",
      description:
    ...
    },
    {
      ...
      image: d,
      alt: "AI Resume Screener – LLM-powered resume analysis",
      description:
    ...
    },
    {
      ...
      image: e,
      alt: "AI Trading Assistant – stock market insights with OpenAI",
      description:
    ...
    },
    {
      ...
      image: f,
      alt: "Customer Support Chatbot – AI assistant for queries",
      description:
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>Our Projects | GOTBAE Portfolio</title>
        <meta
          name="description"
          content="Explore GOTBAE's portfolio of AI tools, web platforms, e-commerce stores, and digital solutions including AI Resume Screener, PPC automation, and more."
        />
        <meta
          name="keywords"
          content="GOTBAE projects, AI tools, PPC automation, e-commerce development, portfolio, web development, AI chatbot, LangChain, OpenAI"
        />
      ...
      <main className="min-h-screen bg-white relative overflow-hidden">
        {/* Curtain Animation */}
        <div
          className={`fixed inset-0 z-50 flex transition-all duration-1000 ${
            curtainOpen ? 'pointer-events-none' : ''
          }`}
        >
          <div
            className={`w-1/2 h-full bg-gradient-to-r from-green-900 to-blue-900 transition-all duration-1000 transform ${
              curtainOpen ? '-translate-x-full' : 'translate-x-0'
            }`}
          ></div>
          <div
            className={`w-1/2 h-full bg-gradient-to-l from-blue-900 to-green-900 transition-all duration-1000 transform ${
              curtainOpen ? 'translate-x-full' : 'translate-x-0'
            }`}
          ></div>
        </div>
        ...
        <button
          onClick={onBack}
          className={`fixed top-6 left-6 z-40 bg-white/90 backdrop-blur-sm text-gray-700 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 ${
        ...
        {/* Hero Section */}
        <header className="relative h-96 flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-900 via-blue-900 to-indigo-900">
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <article
                key={project.id}
                className={`bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-6 hover:scale-105 group cursor-pointer ${
                  isVisible
              ...
              >
                ...
                <div className="p-6">
                  <h2
                    className="text-xl font-bold text-gray-900 mb-3 transform transition-all duration-300 group-hover:text-green-600"
                    style={{ fontFamily: 'Georgia, serif' }}
                  >
                    {project.title}
                  </h2>
                  ...
                  <div className="flex justify-start">
                    <a
                      ...
                      className="flex items-center space-x-2 text-green-600 hover:text-blue-600 transition-all duration-300 transform group-hover:scale-110"
                    >
